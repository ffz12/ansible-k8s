#!/bin/bash
# ============================================================================
#  os-acs-disable.sh —— 关闭所有 PCIe 设备的 ACSCtl
#
...
#
#  用法:
#    os-acs-disable.sh dryrun    只打印会改哪些设备, 不写入
#    os-acs-disable.sh apply     执行关闭(会先备份原值)
#    os-acs-disable.sh restore   从备份恢复原值
#    os-acs-disable.sh status    只统计当前状态
# ============================================================================
set -u

MODE="${1:-status}"
BACKUP_DIR=/var/lib/os-init
